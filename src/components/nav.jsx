...
class Nav extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <nav className="bg-neutral-primary w-full z-20 top-0 inset-s-0 border-none border-default">
          <div className="max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4">
            <Link
              to="/"
              className="self-center text-blue-600 text-3xl capitalize text-heading font-semibold whitespace-nowrap"
            >
              recruiter
            </Link>
            <button
